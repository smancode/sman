...
mkdir -p .sman/gstack/benchmark-reports
mkdir -p .sman/gstack/benchmark-reports/baselines
```
...
Write to `.sman/gstack/benchmark-reports/baselines/baseline.json`.
...
Write to `.sman/gstack/benchmark-reports/{date}-benchmark.md` and `.sman/gstack/benchmark-reports/{date}-benchmark.json`.
