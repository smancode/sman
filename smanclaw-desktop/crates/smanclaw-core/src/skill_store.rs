...
//!
//! Skills are stored in the project's `.sman/skills/` directory as Markdown files
...
const SKILLS_DIR: &str = ".sman/skills";
/// Paths directory name
const PATHS_DIR: &str = ".sman/paths";
...
pub struct SkillStore {
    /// Path to the skills directory (.sman/skills/)
    skills_dir: PathBuf,
}
