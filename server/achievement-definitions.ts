...
const defs: AchievementDef[] = [
  ...
  { id: 'skill_5', category: 'advanced', tier: 'silver', nameKey: 'achievement.skill_5', descKey: 'achievement.skill_5.desc', icon: '🛠️', hidden: true, condition: { metric: 'total_skills_used', threshold: 5 } },
  { id: 'skill_20', category: 'advanced', tier: 'gold', nameKey: 'achievement.skill_20', descKey: 'achievement.skill_20.desc', icon: '🛠️', hidden: true, condition: { metric: 'total_skills_used', threshold: 20 } },
  { id: 'skill_50', category: 'advanced', tier: 'platinum', nameKey: 'achievement.skill_50', descKey: 'achievement.skill_50.desc', icon: '🛠️', hidden: true, condition: { metric: 'total_skills_used', threshold: 50 } },
  { id: 'skill_100', category: 'advanced', tier: 'diamond', nameKey: 'achievement.skill_100', descKey: 'achievement.skill_100.desc', icon: '🛠️', hidden: true, condition: { metric: 'total_skills_used', threshold: 100 } },
  { id: 'skill_500', category: 'advanced', tier: 'star', nameKey: 'achievement.skill_500', descKey: 'achievement.skill_500.desc', icon: '🛠️', hidden: true, condition: { metric: 'total_skills_used', threshold: 500 } },
  ...
  { id: 'codeview_10', category: 'exploration', tier: 'bronze', nameKey: 'achievement.codeview_10', descKey: 'achievement.codeview_10.desc', icon: '👁️', hidden: true, condition: { metric: 'total_code_views', threshold: 10 } },
  { id: 'codeview_50', category: 'exploration', tier: 'silver', nameKey: 'achievement.codeview_50', descKey: 'achievement.codeview_50.desc', icon: '👁️', hidden: true, condition: { metric: 'total_code_views', threshold: 50 } },
  { id: 'codeview_200', category: 'exploration', tier: 'gold', nameKey: 'achievement.codeview_200', descKey: 'achievement.codeview_200.desc', icon: '👁️', hidden: true, condition: { metric: 'total_code_views', threshold: 200 } },
  { id: 'codeview_1k', category: 'exploration', tier: 'platinum', nameKey: 'achievement.codeview_1k', descKey: 'achievement.codeview_1k.desc', icon: '👁️', hidden: true, condition: { metric: 'total_code_views', threshold: 1000 } },
  { id: 'codeview_5k', category: 'exploration', tier: 'diamond', nameKey: 'achievement.codeview_5k', descKey: 'achievement.codeview_5k.desc', icon: '👁️', hidden: true, condition: { metric: 'total_code_views', threshold: 5000 } },

  { id: 'git_10', category: 'exploration', tier: 'bronze', nameKey: 'achievement.git_10', descKey: 'achievement.git_10.desc', icon: '🔀', hidden: true, condition: { metric: 'total_git_ops', threshold: 10 } },
  { id: 'git_50', category: 'exploration', tier: 'silver', nameKey: 'achievement.git_50', descKey: 'achievement.git_50.desc', icon: '🔀', hidden: true, condition: { metric: 'total_git_ops', threshold: 50 } },
  { id: 'git_200', category: 'exploration', tier: 'gold', nameKey: 'achievement.git_200', descKey: 'achievement.git_200.desc', icon: '🔀', hidden: true, condition: { metric: 'total_git_ops', threshold: 200 } },
  { id: 'git_1k', category: 'exploration', tier: 'platinum', nameKey: 'achievement.git_1k', descKey: 'achievement.git_1k.desc', icon: '🔀', hidden: true, condition: { metric: 'total_git_ops', threshold: 1000 } },
  { id: 'git_5k', category: 'exploration', tier: 'diamond', nameKey: 'achievement.git_5k', descKey: 'achievement.git_5k.desc', icon: '🔀', hidden: true, condition: { metric: 'total_git_ops', threshold: 5000 } },

  // ── Collaboration (画饼展示；未来组队/星图上线后，从数据库拉取 total_collabs 和 total_reputation) ──
