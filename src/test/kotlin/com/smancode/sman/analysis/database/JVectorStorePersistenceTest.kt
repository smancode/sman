...
class JVectorStorePersistenceTest {
    ...
    fun testUpdateVectorInH2() {
        ...
        val fragment2 = com.smancode.sman.analysis.model.VectorFragment(
            id = "update-test",
            title = "更新标题",
            content = "更新内容",
            fullContent = "更新完整内容",
    ...
    ): com.smancode.sman.analysis.model.VectorFragment {
        return com.smancode.sman.analysis.model.VectorFragment(
            id = id,
            title = "测试标题-$id",
            content = content,
