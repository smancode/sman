package com.smancode.smanagent.analysis.sop
...
class CaseSopGenerator(
     ...
     * 推断方法场景
     */
    private fun inferMethodScenario(ast: ClassAstInfo, method: com.smancode.smanagent.analysis.model.MethodInfo): BusinessScenario {
     ...
     * 提取操作步骤（方法级别）
     */
    private fun extractMethodSteps(ast: ClassAstInfo, method: com.smancode.smanagent.analysis.model.MethodInfo): List<SopStep> {
        val steps = mutableListOf<SopStep>()
     ...
     * 提取方法预期结果
     */
    private fun extractMethodExpectedResults(method: com.smancode.smanagent.analysis.model.MethodInfo): List<String> {
        val results = mutableListOf<String>()
     ...
     * 推断方法输出
     */
    private fun inferMethodOutput(method: com.smancode.smanagent.analysis.model.MethodInfo): String {
        return when {
