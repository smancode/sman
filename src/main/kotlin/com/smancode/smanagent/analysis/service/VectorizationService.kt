...
import com.smancode.smanagent.analysis.coordination.VectorizationResult
import com.smancode.smanagent.analysis.parser.MarkdownParser
import com.smancode.smanagent.analysis.storage.VectorRepository
import com.smancode.smanagent.analysis.storage.TieredVectorRepository
...
class VectorizationService(
     ...
     * 处理单个文件
     */
    private fun processFile(mdFile: Path): List<com.smancode.smanagent.analysis.model.VectorFragment>? {
        // 读取文件
     ...
     * 向量化并存储单个向量
     */
    private fun vectorizeAndStore(vector: com.smancode.smanagent.analysis.model.VectorFragment) {
        try {
