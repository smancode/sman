...
import com.smancode.sman.verification.model.SourceInfo
...
class ExpertConsultService(
    ...
    fun consult(request: ExpertConsultRequest): ExpertConsultResponse {
        ...
        // 向量检索相关代码片段
        val searchRequest = com.smancode.sman.verification.model.VectorSearchRequest(
    ...
    private fun buildContext(result: com.smancode.sman.verification.model.VectorSearchResponse): String {
