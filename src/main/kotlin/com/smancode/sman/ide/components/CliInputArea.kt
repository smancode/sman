...
class CliInputArea(
    ...
    private fun setupGraphics(g2: java.awt.Graphics2D, colors: com.smancode.sman.ide.theme.ColorPalette): java.awt.Color {
    ...
    private fun drawPlaceholder(g2: java.awt.Graphics2D, fm: java.awt.FontMetrics, colors: com.smancode.sman.ide.theme.ColorPalette) {
    ...
    private fun drawSuggestion(g2: java.awt.Graphics2D, fm: java.awt.FontMetrics, colors: com.smancode.sman.ide.theme.ColorPalette, suggestion: String) {
