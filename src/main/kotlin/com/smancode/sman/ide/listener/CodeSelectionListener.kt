package com.smancode.sman.ide.listener
...
class CodeSelectionListener(private val project: Project) {
    ...
    companion object {
        ...
        private fun insertCodeReference(editor: Editor, project: Project) {
            ...
            val relativePath = com.smancode.sman.ide.service.PathUtil.toProjectRelativePath(absolutePath, basePath)
            val fileName = virtualFile.name

            // 创建代码引用
            val codeReference = com.smancode.sman.ide.components.CodeReference(
