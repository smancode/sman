package com.smancode.sman.analysis.cli
...
class SimpleAnalysisCli {
    ...
    companion object {
        ...
        fun main(args: Array<String>) {
            if (args.isEmpty()) {
                println("用法: java -cp <classpath> com.smancode.sman.analysis.cli.SimpleAnalysisCli <project-path>")
                println("示例: java -cp build/libs/* com.smancode.sman.analysis.cli.SimpleAnalysisCli ../autoloop")
                exitProcess(1)
            }
