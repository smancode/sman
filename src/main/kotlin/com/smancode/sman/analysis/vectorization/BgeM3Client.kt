...
import com.smancode.sman.analysis.retry.*
import com.smancode.sman.analysis.vectorization.TruncationStrategy as VectorTruncationStrategy
...
class BgeM3Client(
    ...
    private val truncation = AdaptiveTruncation(
        ...
        strategy = when (config.truncationStrategy) {
            com.smancode.sman.analysis.config.TruncationStrategy.HEAD -> VectorTruncationStrategy.HEAD
            com.smancode.sman.analysis.config.TruncationStrategy.TAIL -> VectorTruncationStrategy.TAIL
            com.smancode.sman.analysis.config.TruncationStrategy.MIDDLE -> VectorTruncationStrategy.MIDDLE
            com.smancode.sman.analysis.config.TruncationStrategy.SMART -> VectorTruncationStrategy.SMART
        }
    )
