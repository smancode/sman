...
Write to `~/.sman/gstack/projects/{slug}/{user}-{branch}-eng-review-test-plan-{datetime}.md`:
...
```bash
${SMAN_PLUGINS}/gstack-skills/bin/gstack-review-log '{"skill":"plan-eng-review","timestamp":"TIMESTAMP","status":"STATUS","unresolved":N,"critical_gaps":N,"issues_found":N,"mode":"MODE","commit":"COMMIT"}'
```
