...
```bash
REPORT_DIR=".sman/gstack/design-reports"
...
**Local:** `.sman/gstack/design-reports/design-audit-{domain}-{YYYY-MM-DD}.md`

**Project-scoped:**
```bash
source <(${SMAN_PLUGINS}/gstack-skills/bin/gstack-slug 2>/dev/null) && mkdir -p ~/.sman/gstack/projects/$SLUG
```
Write to: `~/.sman/gstack/projects/{slug}/{user}-{branch}-design-audit-{datetime}.md`
